        ...
        <div className="row tabsWrapper">
          ...
          <div className="col-12">
            <div className="tabsHeader">
              <span className={`tab ${activeTab === 1 ? 'activeTab' : ''}${DisabledTab.selectCategory ? 'disableTab' : ''}`} onClick={() => handleTabClick(1)}>{t('selectedCategory')}</span>
              <span className={`tab ${activeTab === 2 ? 'activeTab' : ''}${DisabledTab.details ? 'disableTab' : ''}`} onClick={() => handleTabClick(2)}>{t('details')}</span>

              {
                CustomFields.length !== 0 &&
                <span className={`tab ${activeTab === 3 ? 'activeTab' : ''}${DisabledTab.extraDet ? 'disableTab' : ''}`} onClick={() => handleTabClick(3)}>{t('extraDetails')}</span>
              }


              <span className={`tab ${activeTab === 4 ? 'activeTab' : ''}${DisabledTab.img ? 'disableTab' : ''}`} onClick={() => handleTabClick(4)}>{t('images')}</span>
              <span className={`tab ${activeTab === 5 ? 'activeTab' : ''}${DisabledTab.loc ? 'disableTab' : ''}`} onClick={() => handleTabClick(5)}>{t('location')}</span>
            </div>
          </div>
          {
          ...
          <div className="col-12">
            <div className="contentWrapper">
              ...
              <div className='row'>
                {
                  activeTab === 1 &&
                  <ContentOne handleCategoryTabClick={handleCategoryTabClick} CurrenCategory={CurrenCategory} currentPage={currentPage} lastPage={lastPage} fetchMoreCategory={fetchMoreCategory} IsLoading={IsLoading} />
                }
                {
                  activeTab === 2 &&
                  <ContentTwo AdListingDetails={AdListingDetails} handleAdListingChange={handleAdListingChange} handleDetailsSubmit={handleDetailsSubmit} handleDeatilsBack={handleDeatilsBack} />
                }
                {
